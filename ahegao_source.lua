...
local Utility = {}
local Objects = {}
function Ahegao:DraggingEnabled(frame, parent)
...
function Ahegao.CreateLib(kavName, themeList)
    ...
    Ahegao:DraggingEnabled(MainHeader, Main)
    ...
    function Ahegao:ChangeColor(prope,color)
